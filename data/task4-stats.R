...
ggsave("task4/ct-by-interaction-task4.png", width=10, height=10, units="cm", type="cairo-png")
...
ggsave("task4/ct-per-trial-task4.png", width=20, height=10, units="cm", type="cairo-png")
...
ggsave("task4/acc-per-trial-task4.png", width=20, height=10, units="cm", type="cairo-png")
