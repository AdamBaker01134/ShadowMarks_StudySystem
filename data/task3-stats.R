...
ggsave("task3/ct-per-trial-task3.png", width=20, height=10, units="cm", type="cairo-png")
...
ggsave("task3/acc-by-interaction-task3.png", width=20, height=10, units="cm", type="cairo-png")
...
ggsave("task3/acc-per-trial-task3.png", width=20, height=10, units="cm", type="cairo-png")
...
DifferenceData <- DataFull %>% 
  group_by(technique,trial) %>% 
  summarise(mean=mean((difference1+difference2)/2,na.rm=TRUE),
            sd=sd((difference1+difference2)/2,na.rm=TRUE),
            se=sd/sqrt(length((difference1+difference2)/2)))
DifferenceData
...
ggsave("task3/difference_to_selection-task3.png", width=20, height=10, units="cm", type="cairo-png")
